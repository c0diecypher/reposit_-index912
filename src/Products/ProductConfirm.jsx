...
function ProductConfirm() {
  ...
  const handleToggle = () => {
    if (userBonus > 0) {
      ...
      let calculatedPrice = Number(productData.price.replace(/[\u00a0₽ ]/g, '').replace(',', '.')) - userBonus;
      setAdjustedPrice(Math.max(calculatedPrice, 5990));
 ...
 useEffect(() => {
  ...
  {dataOpen ? (<div>
                ...
                <br/> 
                В предновогоднее время таможня и логистические узлы обрабатывают много заказов, в связи с этим время доставки заказа может увеличиться. <br/> 
                О всех новостях и логистических форс-мажорах можно узнать подробнее <a className="public-oferta-link" rel="noreferrer" href="https://t.me/zipper_store" target="_blank">в канале</a><br/> 
                </span>
              </div>
              </>)}
  </div>
