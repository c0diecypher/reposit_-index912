                          ...
                          <>
                            ...
                            <div className="warning-bonus-selection">
                              <div className="warning-bonus-selection-box">
                                ...
                                <p><strong>Осталось <span className="rouble-icon"style={{margin:'0px',padding:'0px'}}>₽</span> <div className="refer-friend-title-gradient">{Math.max(0, userBonus - productData.price)}</div></strong></p>
                              </div>
                          </div>
