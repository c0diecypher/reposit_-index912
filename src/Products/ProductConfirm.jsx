                          ...
                          <>
                            ...
                            <div className="warning-bonus-selection">
                              <div className="warning-bonus-selection-box">
                                ...
                                <p><strong>При списании бонусов у вас останется: <span className="rouble-icon"style={{margin:'0px',padding:'0px'}}>₽</span> <div className="refer-friend-title-gradient">{userBonus !== null && !isNaN(userBonus) && productData.price !== null && !isNaN(productData.price)
    ? `${Math.max(0, userBonus - (productData.price - adjustedPrice))}₽`
    : 'Ошибка в данных'}</div></strong></p>
                              </div>
                          </div>
